...
const TeamDetails = () => {
    return (
        <div>
            ...
            <div className='mx-1 flex gap-5 flex-col lg:flex-row lg:gap-12 lg:mx-28 bg-white py-16 lg:px-8'>
                <div className='lg:w-[40%]'>
                    <img src={img} alt="" className='rounded-lg' />
                    <div className='ml-2 lg:ml-10 flex flex-col gap-3 lg:gap-6 mt-5'>
                ...
                <div className='mx-3 flex flex-col-reverse lg:flex-col lg:w-[60%]'>
                    <div>
